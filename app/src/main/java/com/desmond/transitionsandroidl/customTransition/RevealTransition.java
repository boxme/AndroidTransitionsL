...
/**
 * Created by desmond on 21/8/15.
 */
public class RevealTransition extends Visibility {

    public static final String TAG = RevealTransition.class.getSimpleName();
...
//        view.setAlpha(0f);
        ...
        final Animator reveal = createAnimator(view, 0, radius);
...
//                view.setAlpha(originalAlpha);
    ...
    static float calculateMaxRadius(final View view) {
        final float widthSquared = view.getWidth() * view.getWidth();
        final float heightSquared = view.getHeight() * view.getHeight();
